...
import Conversion
reader = Reader('texte_image')
#print(reader.get_bytes(10))
writer = Writer('foo')
#decoder_base64_operation_logique(
doc=Conversion.decoder_base64_operation_logique("iVBORw0KGgoAAAANSUhEUgAAAQAAAAE")
print(doc)
#print(Conversion.decoder_base64_operation_logique(reader.get_bytes(3)))
writer.write_bytes(reader.get_bytes(35817))
writer.close()
